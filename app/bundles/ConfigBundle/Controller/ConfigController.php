        ...
        return $this->delegateView(
            [
                'viewParameters' => [
                    ...
                    'extendedSettings' => $this->get( 'mautic.helper.core_parameters' )->get( 'extended_settings' ), // get access to custom parameter from plugins/MauticMarketingMonkeysContactsLimiterBundle/Config/config.php
                ],
