    ...
    <div class="col-md-3 bg-white height-auto">
        <div class="pr-lg pl-lg pt-md pb-md">
            ...
            <?php foreach ($configKeys as $i => $key) : ?>
                ...
                <?php else:
                    if (
                        // hide API, Assets, Form and User Settings tabs if $extendedSettings = false
                        $key !== 'apiconfig' &&
                        $key !== 'assetconfig' &&
                        $key !== 'formconfig' &&
                        $key !== 'userconfig'
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade <?php echo 0 === $i ? 'in active' : ''; ?> bdr-w-0" id="<?php echo $key; ?>">
                <div class="pt-md pr-md pl-md pb-md">
                    <?php echo $view['form']->widget( $form[$key], ['formConfig' => $formConfigs[$key], 'extendedSettings' => $extendedSettings] ); ?>
                </div>
            </div>
            <?php endforeach; ?>
        </div>
