...
class MenuRenderer implements RendererInterface
{
    ...
    public function __construct(MatcherInterface $matcher, TemplatingHelper $templatingHelper, CoreParametersHelper $coreParametersHelper, array $defaultOptions = [])
    {
        ...
        $this->defaultOptions = array_merge(
            [
                ...
                'clear_matcher'     => true,
                'extended_settings' => $coreParametersHelper->get( 'extended_settings' )
            ],
            $defaultOptions
        );
    }
