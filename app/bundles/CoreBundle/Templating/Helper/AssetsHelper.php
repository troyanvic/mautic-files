...
class AssetsHelper
{
    ...
    public function outputSystemScripts($includeEditor = false)
    {
        ...
        // include fullCalendar languages
        $assets['js'] = array_merge( $assets['js'], $this->getFullCalendarLanguages() );
    ...
    /**
     * Load fullCalendar language files.
     *
     * @return array
     */
    public function getFullCalendarLanguages()
    {
        $lang = 'app/bundles/CoreBundle/Assets/js/libraries/fullcalendar/lang/';

        return [
            $lang . 'de.js?v' . $this->version
        ];
    }
