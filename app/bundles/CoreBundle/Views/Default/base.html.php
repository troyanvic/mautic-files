 ...
 * @var Mautic\CoreBundle\Controller\CommonController $accountDisabled
 * @var Mautic\CoreBundle\Controller\CommonController $disabledText
 */
$monkeys_version = true;

if ( $accountDisabled ) {
	echo $view->render( 'MauticCoreBundle:Default:disabled.html.php', array( 'disabledText' => $disabledText ) );
} else { ?>
    <!DOCTYPE html>
