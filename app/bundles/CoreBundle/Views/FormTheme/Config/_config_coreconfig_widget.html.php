 ...
 *
 * @var Mautic\ConfigBundle\Controller\ConfigController $extendedSettings
 */
$fields    = $form->children;
$fieldKeys = array_keys($fields);
$template  = '<div class="col-md-6">{content}</div>';

if (count(array_intersect($fieldKeys, ['site_url', 'webroot', 'update_stability', 'cache_path', 'log_path', 'theme', 'image_path']))): ?>
    <div class="panel panel-primary <?php echo !$extendedSettings ? ' panel--hidden': '' ?>">
...
if (count(array_intersect($fieldKeys, ['default_pagelist', 'timezone', 'locale', 'date_format_full', 'date_format_short', 'date_format_dateonly', 'date_format_timeonly']))): ?>
...
if (count(array_intersect($fieldKeys, ['trusted_hosts', 'trusted_proxies', 'ip_lookup_service', 'do_not_track_ips', 'do_not_track_bots', 'transliterate_page_title']))): ?>
    <div class="panel panel-primary <?php echo !$extendedSettings ? ' panel--hidden': '' ?>">
        <div class="panel-heading">
